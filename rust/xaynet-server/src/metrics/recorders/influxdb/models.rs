...
mod tests {
    ...
    fn test_basic_event() {
        ...
        assert!(event
            ...
            .unwrap()
            .get()
            .starts_with("events title=\"error\" "))
    }
    ...
    fn test_event_with_description() {
        ...
        assert!(event
            ...
            .unwrap()
            .get()
            .starts_with("events title=\"error\",description=\"description\" "))
    }
    ...
    fn test_event_with_description_and_tag() {
        ...
        assert!(event
            ...
            .unwrap()
            .get()
            .starts_with("events title=\"error\",description=\"description\",tags=\"tag\" "))
    }
    ...
    fn test_event_with_description_and_tags() {
        ...
        assert!(event.into_query().build().unwrap().get().starts_with(
            "events title=\"error\",description=\"description\",tags=\"tag_1,tag_2\" "
        ))
    }
    ...
    fn test_event_with_tag() {
        ...
        assert!(event
            ...
            .unwrap()
            .get()
            .starts_with("events title=\"error\",tags=\"tag\" "))
    }
}
